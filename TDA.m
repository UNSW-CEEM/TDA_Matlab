...
% Loading the project
    ...
    function UpdateTariffList(src,evnt)
        ...
        if size(intersect(indetype,intersect(indestate,intersect(indeyear,indeprovider))))>0
            h.AllTariffs_Filtered=h.TariffList.AllTariffs(1,intersect(indetype,intersect(indestate,intersect(indeyear,indeprovider))));
...
% Creating a new tariff
    function CreateTar(src,evnt,Type)
        ...
        h.CreateTar_F.TInfo= uicontrol(h.CreateTar_F.P,'Style','Text',...
            'String',['Info:'], ...
            'FontUnits','normalized',...
            'ToolTipStrin','Additional info for this tariff. It will show up when you hover over the name of tariff once you select it.',...
        ...
        h.NewNUOS= uicontrol(h.CreateTar_F.P,'Style','Pushbutton',...
            ...
            'FontUnits','normalized',...
            'Value',0,...
            'ToolTipStrin','Make NUOS equivalent to DUOS+TUOS',...
