...
%% Info
% Copyright (C) 2017-2019, Navid Haghdadi, n.haghdadi@unsw.edu.au
...
uimenu(h.MenuTariff_cre_Net,'Label','Time of Use','Callback',{@CreateTar_Net,'TOU'});
uimenu(h.MenuTariff_cre_Net,'Label','Time of Use Seasonal','Callback',{@CreateTar_Net,'TOUSeas'});
uimenu(h.MenuTariff_cre_Net,'Label','Demand Charge','Callback',{@CreateTar_Net,'Demand'});
...
uimenu(h.MenuTariff_cre_Ret,'Label','Time of Use','Callback',{@CreateTar_Ret,'TOU'});
uimenu(h.MenuTariff_cre_Ret,'Label','Time of Use Seasonal','Callback',{@CreateTar_Ret,'TOUSeas'});
uimenu(h.MenuTariff_cre_Ret,'Label','Demand Charge','Callback',{@CreateTar_Ret,'Demand'});
uimenu(h.MenuTariff_cre_Ret,'Label','Demand Charge + TOU','Callback',{@CreateTar_Ret,'Demand_TOU'});
...
h.tabg_SelTar_Retail = uitab('parent',h.tabg_SelTar, 'title', 'Retail');
h.tabg_SelTar_Retail_P = uipanel('Parent',h.tabg_SelTar_Retail, ...
    'Position',[.0 .0 1 1]);

h.tabg_SelTar_DUOS.Parent=[];
h.tabg_SelTar_TUOS.Parent=[];
h.tabg_SelTar_DTUOS.Parent=[];
...
% Retail
h.DailyChargeSTR_Retail= uicontrol(h.tabg_SelTar_Retail_P,'Style','Text',...
    'String','Daily Charge ($/day):', ...
    'HorizontalAlignment','left',...
    'FontUnits','normalized',...
    'Units', 'normalized', 'Position',[.01 .82 .18 .13]);

h.DailySE_Retail= uicontrol(h.tabg_SelTar_Retail_P,'Style','Edit',...
    'String','N/A', ...
    'HorizontalAlignment','left',...
    'FontUnits','normalized',...
    'CallBack',@TariffPar_CellEditCallback,...
...
h.EnergyCostStr_Retail= uicontrol(h.tabg_SelTar_Retail_P,'Style','Text',...
    'String','Energy Charge ($/kWh):', ...
    'HorizontalAlignment','left',...
    'FontUnits','normalized',...
    'Units', 'normalized', 'Position',[.35 .82 .2 .13]);
    ...
    function SelecTariff(src,evnt)
        ...
        if h.TariffListPup.Value>1
            ...
            if strcmp(h.MyTariff.Sector,'Network')
                ...
                h.tabg_SelTar_DTUOS.Parent= [];
                h.tabg_SelTar_DUOS.Parent= [];
                h.tabg_SelTar_Retail.Parent= h.tabg_SelTar;
            end
            ...
            if strcmp(h.MyTariff.Sector,'Network')
                ...
                if isfield(h.MyTariff.Parameters.Retail,'Daily')
                    h.DailySE_Retail.Visible='on';
                    h.DailySE_Retail.String=num2str(h.MyTariff.Parameters.Retail.Daily.Value);
                    h.DailyChargeSTR_Retail.Visible='on';
                    
                else
                    h.DailySE_Retail.Visible='off';
                ...
                if isfield(h.MyTariff.Parameters.Retail,'Energy')
                    ...
                    h.EnergyCostEdit_Retail.String=num2str(h.MyTariff.Parameters.Retail.Energy.Value);
                    h.EnergyCostStr_Retail.Visible='on';
                else
                    h.EnergyCostEdit_Retail.Visible='off';
                    h.EnergyCostStr_Retail.Visible='off';
                end
                
                % show the table containing all the parameters:
                h.Mytable_Retail=h.MyTariff.Parameters.Retail.Other;
                % put the parameters of the table to the parameters of the tariff
                h.TariffParTable_Retail.Data=table2cell(h.Mytable_Retail);
                h.TariffParTable_Retail.ColumnName=h.Mytable_Retail.Properties.VariableNames;
                
                for i=1:size(h.TariffParTable_Retail.ColumnName,1)
                    temp2= h.TariffParTable_Retail.ColumnName{i,1};
                    if strcmp(temp2,'Unit')||strcmp(temp2,'Comment')||strcmp(temp2,'Bound_unit')
                        h.TariffParTable_Retail.ColumnEditable(1,i)=false;
                    else
                        h.TariffParTable_Retail.ColumnEditable(1,i)=true;
                    ...
                    if isfield(h,'CurrentLoad_Name')
                        ...
                        if  size(h.AllLoads{LoadNo, 2}.Load.kWh,2)>0
                            ...
                            switch h.tabg_SelTar.SelectedTab.Title
                                ...
                                case 'Retail'
                                    h.MyTariff_Com.Parameters=h.MyTariff.Parameters.Retail;
                                    TarCom='Retail';
                            end
...
% updating a tariff and save
    function TariffPar_CellEditCallback(src,evnt)
        ...
        if strcmp(h.MyTariff.Sector,'Network')
            ...
            h.MyTariff.Parameters.Retail.Other=cell2table(h.TariffParTable_Retail.Data);
            
            h.MyTariff.Parameters.Retail.Other.Properties.VariableNames=h.TariffParTable_Retail.ColumnName;
            
            
            if strcmp(h.DailyChargeSTR_Retail.Visible,'on')
                h.MyTariff.Parameters.Retail.Daily.Value=str2num(h.DailySE_Retail.String);
                
            end
            if strcmp(h.EnergyCostStr_Retail.Visible,'on')
                h.MyTariff.Parameters.Retail.Energy.Value=str2num(h.EnergyCostEdit_Retail.String);
...
% Adding a tariff
    function AddTariff(src,evnt)
        ...
        if strcmp(h.MyTariff.Sector,'Network')
            ...
            NewTariff5=h.MyTariff;
            NewTariff5.Parameters=h.MyTariff.Parameters.Retail;
            [TariffOK5,Msg1]=TariffValidity(NewTariff5);
            Msg2='';
            Msg3='';
            Msg4='';
            h.TariffTableOK=TariffOK5;
        end
        if h.TariffTableOK==0
            
            DelMsg;msgbox([Msg1;Msg2;Msg3;Msg4])
            
        else
            
            
            if numel(find(~cellfun(@isempty,strfind({h.TariffList.AllTariffs.Name},h.NewTariffName.String))))>0
                DelMsg;msgbox('There is already a tariff with this name! Please choose a different name and try again!')
            else
                % saving
...
% Creating a new network tariff
    function CreateTar_Net(src,evnt,Type)
        ...
        h.CreateTar_Net_F.F = figure('Name','Create a New Network Tariff','NumberTitle','off', ...
            ...
            'Toolbar','none','Menubar','none'); % Figure to get peak time
        %
        movegui(h.CreateTar_Net_F.F ,'center')
        h.CreateTar_Net_F.P=uipanel('Parent',h.CreateTar_Net_F.F,...
            'Units', 'normalized', 'Position',[0 0 1 1],...
            'FontWeight','bold',...
            'FontSize',8);
        
        h.CreateTar_Net_F.TName= uicontrol(h.CreateTar_Net_F.P,'Style','Text',...
            'String',['Name:'], ...
            'FontUnits','normalized',...
            'Value',1,...
        ...
        h.CreateTar_Net_F.TNameVal= uicontrol(h.CreateTar_Net_F.P,'Style','Edit',...
        ...
        h.CreateTar_Net_F.TProvider= uicontrol(h.CreateTar_Net_F.P,'Style','Text',...
            'String',['Provider:'], ...
            'FontUnits','normalized',...
            'Value',1,...
        ...
        h.CreateTar_Net_F.TProviderVal= uicontrol(h.CreateTar_Net_F.P,'Style','Edit',...
            'String','N/A ', ...
            'FontUnits','normalized',...
            'Value',1,...
        ...
        h.CreateTar_Net_F.TState= uicontrol(h.CreateTar_Net_F.P,'Style','Text',...
            'String',['State:'], ...
            'FontUnits','normalized',...
            'Value',1,...
        ...
        h.CreateTar_Net_F.TStateVal= uicontrol(h.CreateTar_Net_F.P,'Style','popupmenu',...
        ...
        h.CreateTar_Net_F.TYear= uicontrol(h.CreateTar_Net_F.P,'Style','Text',...
            'String',['Year:'], ...
            'FontUnits','normalized',...
            'Value',1,...
        ...
        h.CreateTar_Net_F.TYearVal= uicontrol(h.CreateTar_Net_F.P,'Style','edit',...
            'String','2017/18', ...
            'FontUnits','normalized',...
            'Value',1,...
        ...
        h.CreateTar_Net_F.TInfo= uicontrol(h.CreateTar_Net_F.P,'Style','Text',...
            'String',['Info:'], ...
            'FontUnits','normalized',...
        ...
        h.CreateTar_Net_F.TInfoVal= uicontrol(h.CreateTar_Net_F.P,'Style','edit',...
        ...
        h.CreateTar_Net_F.AT= uicontrol(h.CreateTar_Net_F.P, ...
            'Style','pushbutton', 'String','+',...
        ...
        h.CreateTar_Net_F.RT= uicontrol(h.CreateTar_Net_F.P, ...
            'Style','pushbutton', 'String','-',...
        ...
        h.NewNUOS= uicontrol(h.CreateTar_Net_F.P,'Style','Pushbutton',...
        ...
        h.tabg_creTar = uitabgroup('Parent',h.CreateTar_Net_F.P,'Tag','Loadtabs', ...
        ...
        switch Type
            ...
            case 'FR'
                ...
                h.CreateTar_Net_F.RT.Visible='Off';
                h.CreateTar_Net_F.AT.Visible='Off';
            ...
            case 'FRSeas'
                ...
                h.CreateTar_Net_F.RT.Visible='On';
                h.CreateTar_Net_F.AT.Visible='On';
                h.CT.D.EnergyC_Text.Visible='Off';
                h.CT.D.EnergyC_Val.Visible='Off';
                h.CT.T.EnergyC_Text.Visible='Off';
                h.CT.T.EnergyC_Val.Visible='Off';
...
% Creating a new Retail tariff
    function CreateTar_Ret(src,evnt,Type)
        ...
        h.CreateTar_Ret_F.TName= uicontrol(h.CreateTar_Ret_F.P,'Style','Text',...
            'String',['Name:'], ...
            'FontUnits','normalized',...
            'Value',1,...
            'Units', 'normalized', 'Position',[.01 .9 .15 0.06],...
        ...
        h.CreateTar_Ret_F.TNameVal= uicontrol(h.CreateTar_Ret_F.P,'Style','Edit',...
            'String','New Custom Tariff ', ...
            'FontUnits','normalized',...
            'Value',1,...
            'Units', 'normalized', 'Position',[.17 .9 .40 .06],...
        ...
        h.CreateTar_Ret_F.TProvider= uicontrol(h.CreateTar_Ret_F.P,'Style','Text',...
            'String',['Provider:'], ...
            'FontUnits','normalized',...
            'Value',1,...
            'Units', 'normalized', 'Position',[.60 .9 .15 .06],...
        ...
        h.CreateTar_Ret_F.TProviderVal= uicontrol(h.CreateTar_Ret_F.P,'Style','Edit',...
            'String','N/A ', ...
            'FontUnits','normalized',...
            'Value',1,...
            'Units', 'normalized', 'Position',[.76 .9 .20 .06],...
        ...
        h.CreateTar_Ret_F.TState= uicontrol(h.CreateTar_Ret_F.P,'Style','Text',...
            'String',['State:'], ...
            'FontUnits','normalized',...
            'Value',1,...
            'Units', 'normalized', 'Position',[.01 .795 .13 .06],...
        ...
        h.CreateTar_Ret_F.TStateVal= uicontrol(h.CreateTar_Ret_F.P,'Style','popupmenu',...
            'String',{'ACT','NSW','QLD','VIC','SA','TAS','WA','NT','N/A'}, ...
            'FontUnits','normalized',...
            'Value',1,...
            'Units', 'normalized', 'Position',[.14 .80 .15 .055],...
        ...
        h.CreateTar_Ret_F.TYear= uicontrol(h.CreateTar_Ret_F.P,'Style','Text',...
            'String',['Year:'], ...
            'FontUnits','normalized',...
            'Value',1,...
            'Units', 'normalized', 'Position',[.31 .795 .1 .06],...
        ...
        h.CreateTar_Ret_F.TYearVal= uicontrol(h.CreateTar_Ret_F.P,'Style','edit',...
            'String','2017/18', ...
            'FontUnits','normalized',...
            'Value',1,...
            'Units', 'normalized', 'Position',[.42 .8 .17 .06],...
        ...
        h.CreateTar_Ret_F.TInfo= uicontrol(h.CreateTar_Ret_F.P,'Style','Text',...
            'String',['Info:'], ...
            'FontUnits','normalized',...
            'ToolTipString','Additional info for this tariff. It will show up when you hover over the name of tariff once you select it.',...
            'Units', 'normalized', 'Position',[.6 .795 .1 .06],...
        ...
        h.CreateTar_Ret_F.TInfoVal= uicontrol(h.CreateTar_Ret_F.P,'Style','edit',...
            'String',['Manually created tariff on: ',datestr(now)], ...
            'FontUnits','normalized',...
            'Value',1,...
            'Units', 'normalized', 'Position',[.7 .8 .25 .06],...
        ...
        % Add remove row (only for some tariff types)
        h.CreateTar_Ret_F.AT= uicontrol(h.CreateTar_Ret_F.P, ...
            'Style','pushbutton', 'String','+',...
            'Units', 'normalized', 'Position',[.9 .01 .05 .06],...
            'FontWeight','bold',...
            'FontUnits','normalized',...
        ...
        h.CreateTar_Ret_F.RT= uicontrol(h.CreateTar_Ret_F.P, ...
            'Style','pushbutton', 'String','-',...
            'Units', 'normalized', 'Position',[.84 .01 .05 .06],...
            'FontWeight','bold',...
            'FontUnits','normalized',...
        ...
        h.tabg_creTar = uitabgroup('Parent',h.CreateTar_Ret_F.P,'Tag','Loadtabs', ...
            'Units','normalized','Position',[0 0.1 1 0.67]);
        h.tab_Retail = uitab('parent',h.tabg_creTar, 'title', 'Retail');
        h.tab_Retail_P = uipanel('Parent',h.tab_Retail, ...
            'Position',[.0 .0 1 1]);
        
        uicontrol(h.CreateTar_Ret_F.P, ...
            'Style','pushbutton', 'String','Add',...
            'Units', 'normalized', 'Position',[.79 .72 .1 .07],...
            'FontWeight','bold',...
            'FontUnits','normalized',...
            'TooltipString',['Save this tariff'],...
            'Callback', {@SetnewTariff,'Retail'});
        ...
        % Retail
        h.CT.D.DailyC_Text= uicontrol(h.tab_Retail_P,'Style','Text',...
            'String',['Daily Charge ($/day):'], ...
            'FontUnits','normalized',...
            'Value',1,...
        ...
        switch Type
            ...
            case 'FR'
                ...
                h.CreateTar_Ret_F.RT.Visible='Off';
                ...
                h.tab_Retail_table.ColumnEditable=[true true false];
            ...
            case 'TOUSeas'
                ...
                h.tab_Retail_table.Data=table2cell(h.CTTable);
                h.tab_Retail_table.ColumnName=h.CTTable.Properties.VariableNames;
                h.tab_Retail_table.ColumnEditable=[true true false true true true true true true true true];
            ...
            case 'Demand'
                ...
                h.tab_Retail_table.Data=table2cell(h.CTTable);
                h.tab_Retail_table.ColumnName=h.CTTable.Properties.VariableNames;
                h.tab_Retail_table.ColumnEditable=[true true false true true true true true true true true true true true true true true true];
    ...
    function AddRowToTariff(src,evnt)
        ...
        try
            h.tab_Retail_table.Data=[h.tab_Retail_table.Data;h.tab_Retail_table.Data(end,:)];
...
% set the new tariff
    function SetnewTariff(src,evnt,Sector)
        
        h.TariffNew.Sector=Sector;
        ...
        if strcmp(h.TariffNew.Sector,'Network')
            
            h.TariffNew.Provider=h.CreateTar_Net_F.TProviderVal.String;
            h.TariffNew.State=h.CreateTar_Net_F.TStateVal.String{h.CreateTar_Net_F.TStateVal.Value};
            h.TariffNew.Name=h.CreateTar_Net_F.TNameVal.String;
            h.TariffNew.Info=h.CreateTar_Net_F.TInfoVal.String;
            h.TariffNew.Year=h.CreateTar_Net_F.TYearVal.String;
            ...
            h.TariffNew.Provider=h.CreateTar_Ret_F.TProviderVal.String;
            h.TariffNew.State=h.CreateTar_Ret_F.TStateVal.String{h.CreateTar_Ret_F.TStateVal.Value};
            h.TariffNew.Name=h.CreateTar_Ret_F.TNameVal.String;
            h.TariffNew.Info=h.CreateTar_Ret_F.TInfoVal.String;
            ...
            h.TariffNew.Parameters.Retail.Other=cell2table(h.tab_Retail_table.Data);
            h.TariffNew.Parameters.Retail.Other.Properties.VariableNames=h.tab_Retail_table.ColumnName;
            
            NewTariff1=h.TariffNew;
            NewTariff1.Parameters=h.TariffNew.Parameters.Retail;
